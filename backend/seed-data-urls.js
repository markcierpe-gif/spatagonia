...
// URLs de imágenes (servidas desde /images)
const photoUrls = [
    '/images/descarga (1).jpg',
    '/images/descarga (2).jpg',
    '/images/descarga (3).jpg',
    '/images/descarga (4).jpg',
    '/images/descarga (5).jpg',
    '/images/descarga.jpg',
    '/images/Femeie modernă.jpg',
    '/images/Instagram model.jpg',
    '/images/Modelo virtual IA con estética clean girl.jpg'
];
...
async function seedData() {
    try {
        console.log('\n🌱 Iniciando seed de datos con URLs...\n');
        ...
        for (let i = 0; i < 20; i++) {
            ...
            const fotoUrl = photoUrls[i % photoUrls.length];
            ...
            try {
                await query(
                    ...
                    [
                        ...
                        fotoUrl,  // URL en lugar de base64
                        enLinea,
                        telefono,
                        whatsapp
                    ]
